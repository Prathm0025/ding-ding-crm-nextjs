...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className="fixed lg:sticky top-0 lg:left-0 left-[-100%] z-40 h-screen lg:h-[calc(100vh-0px)] transition-transform  sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full flex flex-col justify-between px-3  overflow-y-auto bg-gray-100 dark:bg-gray-800">
          ...
          <button
            ...
            className="flex mb-2 items-center  justify-center p-2  border-[#27a5ff] border-[3px] hover:bg-opacity-45 transition-all  rounded-lg text-gray-800 dark:text-white bg-[#27a5ff] bg-opacity-25 group"
          >
